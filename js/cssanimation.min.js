...
*/
var CSSAnimation={version:"0.2a"};CSSAnimation.find=function(a){for(var g=document.styleSheets,d=g.length-1;d>=0;d--){var b=g[d];b=b.cssRules?b.cssRules:b.rules?b.rules:[];for(var c=b.length-1;c>=0;c--)if(b[c].type===window.CSSRule.WEBKIT_KEYFRAMES_RULE&&b[c].name==a)return b[c]}return null};
